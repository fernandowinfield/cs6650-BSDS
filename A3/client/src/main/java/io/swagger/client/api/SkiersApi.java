 ...
 * An API for an emulation of skier management system for RFID tagged lift tickets. Basis for CS6650 Assignments for 2019
 *
...
public class SkiersApi {
  ...
  @SuppressWarnings("rawtypes")
  private com.squareup.okhttp.Call writeNewLiftRideValidateBeforeCall(
      LiftRide body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
   ...
   * @throws ApiException If fail to process the API call, e.g. serializing the request body object
   */
  public com.squareup.okhttp.Call writeNewLiftRideAsync(
      LiftRide body, final ApiCallback<Void> callback) throws ApiException {
