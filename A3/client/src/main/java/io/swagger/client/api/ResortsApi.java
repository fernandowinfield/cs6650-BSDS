...
import io.swagger.client.ProgressResponseBody.ProgressListener;
...
public class ResortsApi {
     ...
     */
    public com.squareup.okhttp.Call getTopTenVertCall(List<String> resort, List<String> dayID, final ProgressListener progressListener, final ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getTopTenVertValidateBeforeCall(List<String> resort, List<String> dayID, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestListener progressRequestListener) throws ApiException {
